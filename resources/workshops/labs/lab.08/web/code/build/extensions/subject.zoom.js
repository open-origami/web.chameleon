...
let SZoom = (_dec = Extension(Subject), _dec2 = Point(SPoint), _dec3 = Extends(MLog), _dec4 = Extends(MGuard), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class SZoom {
  constructor(core) {
    this.core = core;
  }
