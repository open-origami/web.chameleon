...
const Name = '[SLean]';
let SLean = (_dec = Extension(Subject), _dec2 = Point(SPoint), _dec3 = Extends(AGuard), _dec4 = Extends(ALog), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class SLean {
  constructor(core) {
    this.core = core;
    this.name = Name;
    this.off();
